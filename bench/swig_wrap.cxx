...
#define SWIG_CODE_SPLITTING
#ifdef SWIG_CODE_SPLITTING
# define SWIGINTERN
# define SWIGRUNTIME
#endif
...
SWIGRUNTIME inline Napi::Error SWIG_NAPI_NewError(Napi::Env env, Napi::Value obj, const char *msg = SWIG_NULLPTR, swig_type_info *info = SWIG_NULLPTR);
...
// Instantiaed version of the above CRTP class
...
extern swig_type_info *swig_type_initial[];
extern swig_cast_info *swig_cast_initial[];
...
template <typename SWIG_OBJ_WRAP>
class _exports_String_templ : public SWIG_NAPI_ObjectWrap_templ<SWIG_OBJ_WRAP> {
public:
  _exports_String_templ(const Napi::CallbackInfo &);
_exports_String_templ(bool, const Napi::CallbackInfo &);
// jsnapi_class_method_declaration
Napi::Value _wrap_new_String(const Napi::CallbackInfo &);
// jsnapi_class_method_declaration
Napi::Value _wrap_String_length(const Napi::CallbackInfo &);
virtual ~_exports_String_templ();
// jsnapi_class_epilogue_template
};
// jsnapi_class_instance
class _exports_String_inst : public _exports_String_templ<_exports_String_inst> {
public:
  using _exports_String_templ::_exports_String_templ;
  virtual ~_exports_String_inst() = default;
  static void GetMembers(
    Napi::Env,
    std::map<std::string, _exports_String_templ::PropertyDescriptor> &,
    std::map<std::string, _exports_String_templ::PropertyDescriptor> &
    );
  static Napi::Function GetClass(Napi::Env);
};
...
_exports_String_templ<SWIG_OBJ_WRAP>::_exports_String_templ(const Napi::CallbackInfo &info)
:SWIG_NAPI_ObjectWrap_templ<SWIG_OBJ_WRAP>(true, info) {
  Napi::Env env = info.Env();
  
  this->info = SWIGTYPE_p_String;
  ...
  if(static_cast<int>(info.Length()) < 1 || static_cast<int>(info.Length()) > 1) {
    SWIG_Error(SWIG_ERROR, "Illegal number of arguments for _wrap_new_String.");
  }
  {
    {
...
template <typename SWIG_OBJ_WRAP>
_exports_String_templ<SWIG_OBJ_WRAP>::_exports_String_templ(bool, const Napi::CallbackInfo &info)
:SWIG_NAPI_ObjectWrap_templ<SWIG_OBJ_WRAP>(true, info) {
...
// js_function
template <typename SWIG_OBJ_WRAP>
Napi::Value _exports_String_templ<SWIG_OBJ_WRAP>::_wrap_String_length(const Napi::CallbackInfo &info) {
  Napi::Env env = info.Env();
  Napi::Value jsresult;
  ...
  try {
    ...
    if(static_cast<int>(info.Length()) < 0 || static_cast<int>(info.Length()) > 0) {
      SWIG_Error(SWIG_ERROR, "Illegal number of arguments for _wrap_String_length.");
    }
    
    res1 = SWIG_ConvertPtr(info.This(), &argp1,SWIGTYPE_p_String, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
...
// js_dtoroverride
template <typename SWIG_OBJ_WRAP>
_exports_String_templ<SWIG_OBJ_WRAP>::~_exports_String_templ() {
  auto arg1 = reinterpret_cast<String *>(this->self);
  if (this->owned && arg1) {
    delete arg1;
...
SWIGINTERN swig_type_info _swigt__p_String = {"_p_String", "p_String|String *", 0, 0, (void*)0, 0};
...
SWIGINTERN swig_cast_info _swigc__p_String[] = {  {&_swigt__p_String, 0, 0, 0},{0, 0, 0, 0}};
...
Napi::Value _wrap_strlen(const Napi::CallbackInfo &info) {
  ...
  try {
    ...
    if(static_cast<int>(info.Length()) < 1 || static_cast<int>(info.Length()) > 1) {
      SWIG_Error(SWIG_ERROR, "Illegal number of arguments for _wrap_strlen.");
    }
...
/* Class: String (_exports_String) */
// jsnapi_getclass
Napi::Function _exports_String_inst::GetClass(Napi::Env env) {
  std::map<std::string, _exports_String_templ::PropertyDescriptor> members, staticMembers;
  GetMembers(env, members, staticMembers);
  
  std::vector<_exports_String_inst::PropertyDescriptor> symbolTable;
  for (auto it = members.begin(); it != members.end(); it++)
  symbolTable.push_back(it->second);
  for (auto it = staticMembers.begin(); it != staticMembers.end(); it++)
  symbolTable.push_back(it->second);
  
  return Napi::ObjectWrap<_exports_String_inst>::DefineClass(env, "String", symbolTable);
}

void _exports_String_inst::GetMembers(
  Napi::Env env,
  std::map<std::string, _exports_String_templ::PropertyDescriptor> &members,
  std::map<std::string, _exports_String_templ::PropertyDescriptor> &staticMembers
  ) {
  ...
  members.insert({
    "length",
      _exports_String_templ::InstanceMethod("length",
        &_exports_String_templ::_wrap_String_length,
...
Napi::Function _exports_String_ctor = _exports_String_inst::GetClass(env);
exports.Set("String", _exports_String_ctor);
if (SWIGTYPE_p_String->clientdata == SWIG_NULLPTR) {
  SWIGTYPE_p_String->clientdata = new size_t(0);
}
Napi::FunctionReference *_exports_String_ctor_ref = new Napi::FunctionReference();
*_exports_String_ctor_ref = Napi::Persistent(_exports_String_ctor);
env.GetInstanceData<EnvInstanceData>()->ctor[0] = _exports_String_ctor_ref;
...
// Inheritance for _exports_String (String) <- SWIG_NAPI_ObjectWrap
// jsnapi_setup_inheritance
do {
  Napi::Value protoBase, protoSub;
  NAPI_CHECK_RESULT(_exports_String_ctor.Get("prototype"), protoSub);
  NAPI_CHECK_RESULT(SWIG_NAPI_ObjectWrap_ctor.Get("prototype"), protoBase);
  NAPI_CHECK_MAYBE(setProto.Call({
    _exports_String_ctor, SWIG_NAPI_ObjectWrap_ctor
  }));
  NAPI_CHECK_MAYBE(setProto.Call({
    protoSub, protoBase
  }));
